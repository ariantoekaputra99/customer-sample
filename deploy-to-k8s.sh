...
function show_usage {
  ...
  echo "  -r, --registry REGISTRY    Docker registry to use (default: registry.cloudraya.com/ir-cr-ariantoeka-4447)"
...
# Default values
REGISTRY="registry.cloudraya.com/ir-cr-ariantoeka-4447"
TAG="latest"
NAMESPACE="arianto-cluster"
USE_PERSISTENT=false
USE_INGRESS=false
DOMAIN="ari.jvm.my.id"
SKIP_BUILD=false
...
sed -i.bak "s|image: registry.cloudraya.com/ir-cr-ariantoeka-4447/customer-app.*|image: $REGISTRY/customer-app:$TAG|g" k8s/deployment.yaml
sed -i.bak "s|image: registry.cloudraya.com/ir-cr-ariantoeka-4447/customer-app.*|image: $REGISTRY/customer-app:$TAG|g" k8s/deployment-with-pvc.yaml

# Update image reference in skaffold.yaml
sed -i.bak "s|image: registry.cloudraya.com/ir-cr-ariantoeka-4447/customer-app|image: $REGISTRY/customer-app|g" skaffold.yaml

# Update image reference in pom.xml
sed -i.bak "s|<image>registry.cloudraya.com/ir-cr-ariantoeka-4447/customer-app</image>|<image>$REGISTRY/customer-app</image>|g" pom.xml
